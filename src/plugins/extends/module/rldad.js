layui.define(["jquery", "layer"], function (exports) {
  ...
  DadMouse.prototype.update = function (e) {
    ...
    if (global.supportsTouch && e.type == "touchmove") {
      ...
      var mouseTarget = document.elementFromPoint(targetEvent.clientX, targetEvent.clientY);
  ...
  Dad.prototype.prepare = function (e, $target) {
    ...
    var shouldStartDragging = this.active && ($draggable ? $draggable.is(e.target) || $draggable.find(e.target).length : true);
  ...
  Dad.prototype.updateClonePosition = function () {
    // Get positions
    var targetX = this.mouse.positionX - this.getContainerX() - this.mouse.offsetX;
    var targetY = this.mouse.positionY - this.getContainerY() - this.mouse.offsetY;
  ...
  Dad.prototype.updatePlaceholderPosition = function () {
    ...
    var $target = placeholderTarget ? this.$target.find(placeholderTarget) : this.$target;
